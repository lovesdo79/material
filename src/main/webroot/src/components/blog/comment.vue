			...
			<el-col :span="24">
				...
				<el-form :inline="true" :model="params" class="demo-form-inline">
					...
					<el-form-item label="生日下限">
						<el-date-picker v-model="params.startDate" align="right" type="date" placeholder="生日下限">
						</el-date-picker>
					</el-form-item>
					<el-form-item label="生日上限">
						<el-date-picker v-model="params.endDate" align="right" type="date" placeholder="生日上限">
						</el-date-picker>
					</el-form-item>
				...
				<el-table :data="tableData" border style="width: 100%">
					...
					<el-table-column prop="birthday" label="出生日期" sortable :formatter="dateFormat" width="150">
					</el-table-column>
					<el-table-column prop="userName" label="账户名" width="150">
					</el-table-column>
					<el-table-column prop="userNickname" label="昵称" width="150">
					</el-table-column>
					<el-table-column prop="userTruename" label="真实姓名" width="150">
					</el-table-column>
				...
				<div class="block">
					<el-pagination @size-change="sizeChange" @current-change="currentChange" :current-page="params.pageNum" :page-sizes="[2, 10, 30, 50, 100, 300, 500]" :page-size="params.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total">
					</el-pagination>
				</div>
			</el-col>
		</el-row>
